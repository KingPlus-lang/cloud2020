...
public class PaymentController {
    ...
    public Object discovery(){
        ...
        List<ServiceInstance> instances = discoveryClient.getInstances("CLOUD-PAYMENT-SERVICE");//根据微服务具体名称获取信息
    ...
    public String paymentZipkin(){
        return "hi,i'am paymentaipkin server fall back, welcome to wjf's house,O(∩_∩)O哈哈~";
    }
